$(document).ready(function () {
  ...
  $(".search").on("click", function (event) {
    ...
    console.log("registering modal click");
  $("#authorModalButton").on("click", function (event) {
    event.preventDefault();
    $("#authorsModal").addClass("is-active");
    console.log(event);
  });

  $("#authorsModalClose").on("click", function (event) {
    event.preventDefault();
    $("#authorsModal").removeClass("is-active");
